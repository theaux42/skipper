...
import { Play, Square, RotateCcw, Trash2, Loader2, Rocket } from 'lucide-react'
...
export function ComposeStackControls({ projectId, hasDeployed = false }: { projectId: string; hasDeployed?: boolean }) {
    ...
    return (
        <div className="flex flex-wrap items-center gap-2">
            ...
            >
                ...
                {hasDeployed ? 'Rebuild' : 'Deploy Stack'}
            </Button>
            {hasDeployed && (
                <>
                    <Button
